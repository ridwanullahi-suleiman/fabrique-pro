...
const slides = () => [
    ...
    },
    {
        ...
        description: 'Sale! Up to 50% off!',
        img: 'https://images.pexels.com/photos/17839121/pexels-photo-17839121/free-photo-of-a-woman-in-a-white-top-and-pants-squatting.jpeg?auto=compress&cs=tinysrgb&w=600',
        url: '/',
        bg: 'bg-gradient-to-r from-yellow-50 to-pink-50',
    },
    {
        ...
        description: 'Sale! Up to 50% off!',
        img: 'https://images.pexels.com/photos/13787836/pexels-photo-13787836.jpeg?auto=compress&cs=tinysrgb&w=600',
        url: '/',
        bg: 'bg-gradient-to-r from-yellow-50 to-pink-50',
    },
]
