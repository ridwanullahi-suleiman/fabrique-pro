...
const Navicons = () => {
    ...
    return (
        <div className="flex items-center gap-4 xl:gap-6 relative">
            ...
            {isProfileOpen && (<div className="absolute p-4 rounded-md top-12 left-0 text-sm shadow-[0_30px_10px_rgb(0,0,0,0.2)] z-20">
            ...
            <div className="relative cursor-pointer">
                ...
                <div className="absolute -top-4 -right-4 w-6 h-6 bg-lama text-center  rounded-full text-white text-sm flex justify-center items-center">4</div>
                {isCartOpen && (<div>
                    <CartModal />
                </div>)}
            </div>
